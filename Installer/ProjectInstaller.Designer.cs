...
namespace MachSecure.SVM.OverviewService
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.hostServiceProcessInstaller.Account = System.ServiceProcess.ServiceAccount.LocalSystem;
            this.hostServiceProcessInstaller.Password = null;
            this.hostServiceProcessInstaller.Username = null;
            // 
            // HostServiceInstaller
            // 
            this.HostServiceInstaller.DelayedAutoStart = true;
            this.HostServiceInstaller.ServiceName = "HostService";
        ...
        private ServiceProcessInstaller hostServiceProcessInstaller;
        private ServiceInstaller HostServiceInstaller;
    }
}